...
// Longest first, so `AddressAutocompleteAzure` cannot eat the front of a longer token that
 ...
 * the script has no second act here — and it carries a literal AddressAutocompleteAzure in
